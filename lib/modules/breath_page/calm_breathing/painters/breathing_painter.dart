...
class CalmBreathingPainter extends CustomPainter {
  final double animationValue; // 0.0 to 1.0 (Scale factor for inner circle)

  CalmBreathingPainter({required this.animationValue});
  ...
  @override
  bool shouldRepaint(covariant CalmBreathingPainter oldDelegate) {
