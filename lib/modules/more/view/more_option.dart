  ...
  Widget build(BuildContext context) {
    ...
    return ThemedScaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            padding: EdgeInsets.fromLTRB(16.w, 16.h, 16.w, 16.h), // 🔥 bottom padding added
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Divider(color: AppColors.primarytext.withOpacity(0.3)),
                      ...
                      SettingItem(
                        ...
                        onTap: () {
                          Get.toNamed(
                            AppRoute.getHelpAndSupportPage(),
                          );
                        },
                      ),
                      ...
                      SettingItem(
                        ...
                        onTap: () {
                          Get.toNamed(
                            AppRoute.getTermsAndConditionPage(),
                          );
                        },
                      ),
                ...
                SizedBox(height: 20.h), // 🔥 extra bottom spacing (safe)
              ],
            ),
          ),
        ),
